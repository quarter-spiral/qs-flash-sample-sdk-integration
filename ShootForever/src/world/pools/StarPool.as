...
package world.pools
{
	import world.BackgroundStar;
	
	/** A pool of BackgroundStar objects */
	public class StarPool {
		...
		/** Objects in the pool. */
		private var list:Vector.<BackgroundStar> = new Vector.<BackgroundStar>();
		...
		public function StarPool(create:Function, clean:Function = null, minSize:int = 50, maxSize:int = 200)
		{
			this.create = create;
			this.clean = clean;
		 ...
		 *
		 */
		public function checkOut():BackgroundStar
		{
			if(length == 0) {
				if(size < maxSize) {
					size++;
		 ...
		 *
		 */
		public function checkIn(item:BackgroundStar):void
		{
