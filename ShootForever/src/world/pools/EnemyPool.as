...
package world.pools
{
	...
	public class EnemyPool {
		...
		/** Objects in the pool. */
		private var list:Vector.<Enemy> = new Vector.<Enemy>();
		...
		public function EnemyPool(create:Function, clean:Function = null, minSize:int = 50, maxSize:int = 200)
		{
			this.create = create;
			this.clean = clean;
		 ...
		 *
		 */
		public function checkOut():Enemy
		{
			if(length == 0) {
				if(size < maxSize) {
					size++;
		 ...
		 *
		 */
		public function checkIn(item:Enemy):void
		{
