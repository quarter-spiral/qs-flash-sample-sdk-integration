...
package world.pools
{
	...
	public class BulletPool {
		...
		/** Objects in the pool. */
		private var list:Vector.<Bullet> = new Vector.<Bullet>();
		...
		public function BulletPool(create:Function, clean:Function = null, minSize:int = 50, maxSize:int = 200)
		{
			this.create = create;
			this.clean = clean;
		 ...
		 *
		 */
		public function checkOut():Bullet
		{
			if(length == 0) {
				if(size < maxSize) {
					size++;
		 ...
		 *
		 */
		public function checkIn(item:Bullet):void
		{
