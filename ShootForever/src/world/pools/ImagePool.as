...
package world.pools
{
	...
	public class ImagePool {
		...
		/** Objects in the pool. */
		private var list:Vector.<Image> = new Vector.<Image>();
		...
		public function ImagePool(create:Function, clean:Function = null, minSize:int = 50, maxSize:int = 200)
		{
			this.create = create;
			this.clean = clean;
		 ...
		 *
		 */
		public function checkOut():Image
		{
			if(length == 0) {
				if(size < maxSize) {
					size++;
		 ...
		 *
		 */
		public function checkIn(item:Image):void
		{
